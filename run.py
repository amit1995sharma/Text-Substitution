    ...
    if len(sys.argv) == 2:
        ...
        if arg1 == "resource" and arg2 == "--language":
            if "index.en.properties" in os.listdir() and lang1 in languages.keys():
                ...
                print("Please run the \"python run.py extract-text\" before using the command\nor check the langage first")
        elif arg1 == "display-html" and arg2 == "--language":
            if "index.en.properties" in os.listdir() and lang1 in languages.keys() and "index."+languages[lang1]+".properties" in os.listdir() :
